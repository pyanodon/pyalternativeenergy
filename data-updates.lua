...
RECIPE("py-satellite"):add_ingredient {type = "item", name = "sc-engine", amount = 1}:add_ingredient {type = "item", name = "metastable-quasicrystal", amount = 4}:add_ingredient {type = "item", name = "solar-panel-mk04", amount = 2}:replace_ingredient("fusion-reactor-mk01", "py-rtg"):add_ingredient {type = "item", name = "fuelrod-mk04", amount = 2}
