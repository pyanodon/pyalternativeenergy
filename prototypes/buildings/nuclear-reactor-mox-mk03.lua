...
ENTITY {
    ...
    energy_source =
    {
      ...
      fluid_box =
      {
        volume = 200,
        pipe_connections = {
          {flow_direction = "input-output", position = {-3.0, 7.3}, direction = defines.direction.south},
          {flow_direction = "input-output", position = {-3.0, -7.3}, direction = defines.direction.north}
        },
