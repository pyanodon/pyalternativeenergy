...
ENTITY {
    ...
    fluid_box = {
        ...
        pipe_connections = {
            {flow_direction = "input-output", position = {2.5, 6.5}, direction = defines.direction.south},
            {flow_direction = "input-output", position = {-2.5, 6.5}, direction = defines.direction.south},
            {flow_direction = "input-output", position = {2.5, -6.5}, direction = defines.direction.north},
            {flow_direction = "input-output", position = {-2.5, -6.5}, direction = defines.direction.north},

            
            {flow_direction = "input-output", position = {2.5, 7.5}, direction = defines.direction.south},
            {flow_direction = "input-output", position = {-2.5, 7.5}, direction = defines.direction.south},
            {flow_direction = "input-output", position = {2.5, -7.5}, direction = defines.direction.north},
            {flow_direction = "input-output", position = {-2.5, -7.5}, direction = defines.direction.north},

            
            {flow_direction = "input-output", position = {2.5, 8.5}, direction = defines.direction.south},
            {flow_direction = "input-output", position = {-2.5, 8.5}, direction = defines.direction.south},
            {flow_direction = "input-output", position = {2.5, -8.5}, direction = defines.direction.north},
            {flow_direction = "input-output", position = {-2.5, -8.5}, direction = defines.direction.north},
