...
ENTITY {
    ...
    energy_source =
    {
      ...
      fluid_box =
      {
        volume = 200,
        pipe_connections = {
          {flow_direction = "input-output", position = {0, 5.3}, direction = defines.direction.south},
          {flow_direction = "input-output", position = {0, -5.3}, direction = defines.direction.north}
        },
