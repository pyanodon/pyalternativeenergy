...
ITEM {
    type = "item",
    name = "antimonium-drill-mk03",
    icon = "__pyalternativeenergygraphics__/graphics/icons/antimonium-drill-mk03.png",
    icon_size = 64,
    flags = {},
    subgroup = "py-alternativeenergy-buildings-mk03",
    order = "a",
    place_result = "antimonium-drill-mk03",
    stack_size = 10
}
...
ENTITY {
    ...
    minable = {mining_time = 1, result = "antimonium-drill-mk03"},
