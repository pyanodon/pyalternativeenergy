...
ITEM {
    ...
    order = "d",
    place_result = "tidal-placer-mk03",
    stack_size = 10
}
...
ENTITY {
    ...
    fast_replaceable_group = "tidal-mk03",
    max_health = 400,
    corpse = "big-remnants",
...
ENTITY {
    ...
    circuit_connector = {
        {
            sprites = circuit_connector_definitions["offshore-pump"].sprites,
            points = circuit_connector_definitions["offshore-pump"].points
        },
        {
            sprites = circuit_connector_definitions["offshore-pump"].sprites,
            points = circuit_connector_definitions["offshore-pump"].points
