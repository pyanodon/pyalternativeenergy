...
}):add_unlock("coalplant-mk01"):add_unlock("oilplant-mk01"):add_unlock("biomassplant-mk01"):add_unlock("gasplant-mk01")
...
RECIPE({
    ...
    main_product = "pressured-steam",
}):add_unlock("coalplant-mk02"):add_unlock("oilplant-mk02"):add_unlock("biomassplant-mk02"):add_unlock("gasplant-mk02")
...
RECIPE({
    ...
    main_product = "pressured-steam",
}):add_unlock("coalplant-mk03"):add_unlock("oilplant-mk03"):add_unlock("biomassplant-mk03"):add_unlock("gasplant-mk03")
...
RECIPE({
    ...
    main_product = "pressured-steam",
}):add_unlock("coalplant-mk04"):add_unlock("oilplant-mk04"):add_unlock("biomassplant-mk04"):add_unlock("gasplant-mk04")
