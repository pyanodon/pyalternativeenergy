...
TECHNOLOGY("pharmacogenomics"):add_pack("military-science-pack")
...
RECIPE("plankton-farm"):add_ingredient({ type = "item", name = "intermetallics", amount = 7 })
...
RECIPE("rc-mk02"):add_ingredient({ type = "item", name = "eva", amount = 100 }):add_ingredient({ type = "item", name = "self-assembly-monolayer", amount = 12 }):add_ingredient({ type = "item", name = "mechanical-parts-01", amount = 10 })
...
RECIPE("wyrmhole"):add_ingredient({ type = "item", name = "metastable-quasicrystal", amount = 20 }):add_ingredient({ type = "item", name = "sc-engine", amount = 5 }):add_ingredient({ type = "item", name = "mechanical-parts-04", amount = 1 })
...
RECIPE("cellulose-00"):remove_unlock("cellulose-mk01"):add_unlock("electronics")
