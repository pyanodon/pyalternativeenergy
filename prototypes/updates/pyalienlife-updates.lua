...
RECIPE("grod-seeds-mk02-soaker"):set_fields{category = 'centrifuging'}:set_fields{energy_required = 4}
RECIPE("grod-seeds-mk03-soaker"):set_fields{category = 'centrifuging'}:set_fields{energy_required = 4}
RECIPE("grod-seeds-mk04-soaker"):set_fields{category = 'centrifuging'}:set_fields{energy_required = 4}
