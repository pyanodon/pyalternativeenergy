...
RECIPE("bof-mk04"):add_ingredient({type = "item", name = "metastable-quasicrystal", amount = 10})
RECIPE("smelter-mk04"):add_ingredient({type = "item", name = "metastable-quasicrystal", amount = 15})
RECIPE("casting-unit-mk04"):add_ingredient({type = "item", name = "metastable-quasicrystal", amount = 8})
RECIPE("eaf-mk04"):add_ingredient({type = "item", name = "metastable-quasicrystal", amount = 6})
RECIPE("electrolyzer-mk04"):add_ingredient({type = "item", name = "metastable-quasicrystal", amount = 5})
RECIPE("flotation-cell-mk04"):add_ingredient({type = "item", name = "metastable-quasicrystal", amount = 10})
RECIPE("hydroclassifier-mk04"):add_ingredient({type = "item", name = "metastable-quasicrystal", amount = 8})
RECIPE("impact-crusher-mk04"):add_ingredient({type = "item", name = "metastable-quasicrystal", amount = 6})
RECIPE("leaching-station-mk04"):add_ingredient({type = "item", name = "metastable-quasicrystal", amount = 4})
...
RECIPE("sinter-unit"):add_ingredient({type = "item", name = "metastable-quasicrystal", amount = 20})
